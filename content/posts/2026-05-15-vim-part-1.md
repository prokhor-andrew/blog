...
In this little post, I will focus on vim modes, basic navigation, and commands that allow to do some character modifications. 

It is important to practice switching modes, navigation, and running commands.
...
Normal mode is usually the starting point. 
